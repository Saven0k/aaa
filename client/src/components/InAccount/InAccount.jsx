...
const InAccount = () => {
    ...
    const changePost = (id, name, text) => {
        return (
            <>
                {/* Вывоз функции для изменения поста */}
            </>
        )
    }
    ...
    const AllOk = () => {
        return (postsList.map((post, index) => (
            <div className='post' key={index}>
                <div className='inputs' style={{gap: post.id === idActivePost ? "10px" : "0" }}>
                    <input
                        className='input'
                        ...
                        style={{border: post.id === idActivePost ? "1px solid #000" : "none"}}
                    ...
                    <div className="buttons">
                        ...
                        <button 
                            ...
                            style={{display: idActivePost != null ? "flex": "none"}}
                        >Сохранить</button>
                    </div>
                </div>
                <img className='img' src={esc} onClick={() => DeletePost(post.id)} />
            </div>
        )))
    }
    ...
    return (
        <div className='account'>
            <div className='newPost'>
                <form id="form" action="submit" className='form'>
                    <div className='subs'>
                    ...
                    <button className='button' onClick={writeTo} type='submit'>Добавить пост</button>
                </form>
            </div>
            <div className='Main'>
